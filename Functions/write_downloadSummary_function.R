write_downloadSummary <- function(method, dpID, dpName, site, dates, package, size, path) {
  one <- paste0("CyVerse NEON Browser ", method, " Download Summary")
  ...
  nine <- "The CyVerse NEON Browser is a multifunctional R Shiny map tool hosted by CyVerse and designed to make NEON data accessible, visualized, and easy to interact with. Check it out at https://github.com/Danielslee51/CyVerse-NEON-Browser."

                                                                  ...
                                                                  tabsetPanel(id = "data",
                                                                              ...
                                                                              tabPanel("Product Catalog", value = "find",
                                                                                       ...
                                                                                       conditionalPanel("input.NEON_browsing_type == 'product'",
                                                                                                        ...
                                                                                                        awesomeRadio(inputId = "NEON_browsing_step_product", label = NULL, choices = list("Find Product" = "list", "Get Availability" = "single"), status = "info", inline = TRUE),
                                                                              ...
                                                                              tabPanel("Product Download",  value = "download",
                                                                                       ...
                                                                                       conditionalPanel("input.NEON_download_type == 'general'",
                                                                                                        ...
                                                                                                        actionButton(inputId = "TEST", label = "Click"),

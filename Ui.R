                                                                  ...
                                                                  tabsetPanel(id = "data",
                                                                              ...
                                                                              tabPanel("Product Download",  value = "download",
                                                                                       ...
                                                                                       conditionalPanel("input.NEON_download_type == 'general'",
                                                                                                        ...
                                                                                                        selectInput(inputId = "location_NEON_general", label = "Field Site", choices = FieldSite_abbs),
                                                                                                        ...
                                                                                                        actionButton(inputId = "download_NEON_general", label = "Download Items", icon = icon(name = "download")),
                                                                                                        disabled(downloadLink(outputId = "transfer_NEON_general", label = NULL))
                                                                                       ),
                                                                                       conditionalPanel("input.NEON_download_type == 'specific'",
                                                                                                        ...
                                                                                                        actionButton(inputId = "download_NEON_specific", label = "Download items", icon = icon(name = "download")),
                                                                                                        disabled(downloadLink(outputId = "transfer_NEON_specific", label = NULL))
                                                                                       ),

fluidPage(theme = shinytheme('cerulean'),
          ...
          useShinyjs(),
          navbarPage(tags$html("CyVerse NEON Browser"),
                                                                  ...
                                                                  tabsetPanel(id = "data",
                                                                              ...
                                                                              tabPanel("Product Catalog", value = "find",
                                                                                       ...
                                                                                       conditionalPanel("input.NEON_browsing_type == 'product'",
                                                                                                        ...
                                                                                                        awesomeRadio(inputId = "NEONbrowsingstep_product", label = NULL, choices = list("Find Product" = "list", "Get Availability" = "single"), status = "info", inline = TRUE),
                                                                              ...
                                                                              tabPanel("Product Download",  value = "download",
                                                                                       ...
                                                                                       disabled(conditionalPanel("input.NEON_download_type == 'specific'",
                                                                                                        ...
                                                                                                        downloadButton(outputId = "transfer_NEON_specific", label = "Transfer Downloads")
                                                                                       )),

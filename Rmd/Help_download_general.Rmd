...
The downloads will appear as a zip file in the form of **NEON\_\<site\>\_\<dpID\>**, which unzips to a folder containing all of the downloads. This data comes straight from the <a href='http://data.neonscience.org/data-api' target='_blank'>NEON API</a>.
